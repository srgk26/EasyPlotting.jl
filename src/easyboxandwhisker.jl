...
function easyboxandwhisker()
    ...
    function easyboxandwhisker_inputs()
        ...
        Interact.Widget(["easyboxandwhisker_dataformat_button"=>easyboxandwhisker_dataformat_button, "easyboxandwhisker_colours"=>easyboxandwhisker_colours, "easyboxandwhisker_scale"=>easyboxandwhisker_scale, "easyboxandwhisker_back_button"=>easyboxandwhisker_back_button, "easyboxandwhisker_plot_button"=>easyboxandwhisker_plot_button]) ## Consolidating all widgets
    end
    ...
    easyboxandwhisker_page = Interact.node(:html,
                                ...
                                Interact.node(:p, easyboxandwhisker_inputs()["easyboxandwhisker_back_button"], style=Dict(:position => "absolute", :left => "650px")),
                                Interact.node(:p, easyboxandwhisker_inputs()["easyboxandwhisker_plot_button"], style=Dict(:position => "absolute", :left => "720px")))
