...
function easyscatterplot2d()
    ...
    function easyscatterplot2d_inputs()
        ...
        Interact.Widget(["easyscatterplot2d_dataformat_button"=>easyscatterplot2d_dataformat_button, "easyscatterplot2d_colours"=>easyscatterplot2d_colours, "easyscatterplot2d_scale"=>easyscatterplot2d_scale, "easyscatterplot2d_back_button"=>easyscatterplot2d_back_button, "easyscatterplot2d_plot_button"=>easyscatterplot2d_plot_button]) ## Consolidating all widgets
    end
    ...
    easyscatterplot2d_page = Interact.node(:html,
                                ...
                                Interact.node(:p, easyscatterplot2d_inputs()["easyscatterplot2d_back_button"], style=Dict(:position => "absolute", :left => "650px")),
                                Interact.node(:p, easyscatterplot2d_inputs()["easyscatterplot2d_plot_button"], style=Dict(:position => "absolute", :left => "720px")))
    ...
    function easyscatterplot2d_plot()
        if easyscatterplot2d_inputs()["easyscatterplot2d_scale"][] == "None" ## For no logarithmic scaling
            StatsPlots.bar(collect(df[:,2]), collect(df[:,3]), xlabel = string(names(df)[2]), ylabel = string(names(df)[3]), color=Symbol(easyscatterplot2d_inputs()["easyscatterplot2d_colours"][]::String), legend=false)
        ...
        elseif easyscatterplot2d_inputs()["easyscatterplot2d_scale"][] == "loge" ## For loge logarithmic scaling
            StatsPlots.bar(log.(collect(df[:,2])), log.(collect(df[:,3])), xlabel = string(names(df)[2]), ylabel = string(names(df)[3]), color=Symbol(easyscatterplot2d_inputs()["easyscatterplot2d_colours"][]::String), legend=false)
            StatsPlots.gui()
            return true
        elseif easyscatterplot2d_inputs()["easyscatterplot2d_scale"][] == "log2" ## For log2 logarithmic scaling
            StatsPlots.bar(log2.(collect(df[:,2])), log2.(collect(df[:,3])), xlabel = string(names(df)[2]), ylabel = string(names(df)[3]), color=Symbol(easyscatterplot2d_inputs()["easyscatterplot2d_colours"][]::String), legend=false)
            StatsPlots.gui()
            return true
        elseif easyscatterplot2d_inputs()["easyscatterplot2d_scale"][] == "log10" ## For log10 logarithmic scaling
            StatsPlots.bar(log10.(collect(df[:,2])), log10.(collect(df[:,3])), xlabel = string(names(df)[2]), ylabel = string(names(df)[3]), color=Symbol(easyscatterplot2d_inputs()["easyscatterplot2d_colours"][]::String), legend=false)
            StatsPlots.gui()
            return true
        end
    end
