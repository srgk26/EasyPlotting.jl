...
function easybarchart()
    ...
    easybarchart_inputsfunc = easybarchart_inputs()
    ...
    easybarchart_page = Interact.node(:html,
                            ...
                            Interact.node(:p, Interact.hbox(Interact.pad(0.5, easybarchart_intro2), Interact.pad(0.25, easybarchart_inputsfunc["easybarchart_dataformat_button"])), style=Dict(:size=>"30", :padding=>"2px", :margin => "0 0 1em 0")),
                            Interact.node(:p, easybarchart_intro3, style=Dict(:size=>"30", :padding=>"2px", :margin => "0 0 1em 0")),
                            Interact.node(:p, Interact.hbox(Interact.pad(0.5, "(Optional) Select fill colour palette for Bar Chart:"), Interact.pad(0.25, easybarchart_inputsfunc["easybarchart_colours"])), style=Dict(:size=>"30", :padding=>"2px", :margin => "0 0 1em 0")),
                            Interact.node(:p, Interact.hbox(Interact.pad(0.5, "(Optional) Select logarithmic scaling options:"), Interact.pad(0.25, easybarchart_inputsfunc["easybarchart_scale"])), style=Dict(:size=>"30", :padding=>"2px", :margin => "0 0 1em 0")),
                            Interact.node(:p, Interact.hbox(Interact.pad(0.5, "(Optional) Enter plot size (numbers only):"), Interact.pad(0.25, easybarchart_inputsfunc["easybarchart_size1"]), Interact.pad(0.25, easybarchart_inputsfunc["easybarchart_size2"])), style=Dict(:size=>"30", :padding=>"2px", :margin => "0 0 1em 0")),
                            Interact.node(:p, Interact.hbox(Interact.pad(0.25, easybarchart_inputsfunc["easybarchart_back_button"]), Interact.pad(0.25, easybarchart_inputsfunc["easybarchart_plot_button"])), style=Dict(:position => "absolute", :left => "650px")))
    ...
    function easybarchart_plot()
        if easybarchart_inputsfunc["easybarchart_size1"][]::String == "" ## If no user-input for plot size
            if easybarchart_inputsfunc["easybarchart_scale"][] == "None" ## For no logarithmic scaling
                StatsPlots.bar(collect(df[:,2]), xlabel = string(names(df)[2]), xticks = (1:length(df[:,1]), df[:,1]), color=Symbol(easybarchart_inputsfunc["easybarchart_colours"][]::String), legend=false)
            ...
            elseif easybarchart_inputsfunc["easybarchart_scale"][] == "loge" ## For loge logarithmic scaling
                StatsPlots.bar(log.(collect(df[:,2])), xlabel = string(names(df)[2]), xticks = (1:length(df[:,1]), df[:,1]), color=Symbol(easybarchart_inputsfunc["easybarchart_colours"][]::String), legend=false)
                StatsPlots.gui()
                return true
            elseif easybarchart_inputsfunc["easybarchart_scale"][] == "log2" ## For log2 logarithmic scaling
                StatsPlots.bar(log2.(collect(df[:,2])), xlabel = string(names(df)[2]), xticks = (1:length(df[:,1]), df[:,1]), color=Symbol(easybarchart_inputsfunc["easybarchart_colours"][]::String), legend=false)
                StatsPlots.gui()
                return true
            elseif easybarchart_inputsfunc["easybarchart_scale"][] == "log10" ## For log10 logarithmic scaling
                StatsPlots.bar(log10.(collect(df[:,2])), xlabel = string(names(df)[2]), xticks = (1:length(df[:,1]), df[:,1]), color=Symbol(easybarchart_inputsfunc["easybarchart_colours"][]::String), legend=false)
                StatsPlots.gui()
                return true
            end
        else ## If plot size is defined by user
            if easybarchart_inputsfunc["easybarchart_scale"][] == "None" ## For no logarithmic scaling
                StatsPlots.bar(collect(df[:,2]), xlabel = string(names(df)[2]), xticks = (1:length(df[:,1]), df[:,1]), color=Symbol(easybarchart_inputsfunc["easybarchart_colours"][]::String), size=(parse(Float64, easybarchart_inputsfunc["easybarchart_size1"][]), parse(Float64, easybarchart_inputsfunc["easybarchart_size2"][])), legend=false)
                StatsPlots.gui() ## Launches PlotlyJS interactive window to interact with plot and save figure
                return true ## Returns true value, thereby stopping while loop that keeps the process running
            elseif easybarchart_inputsfunc["easybarchart_scale"][] == "loge" ## For loge logarithmic scaling
                StatsPlots.bar(log.(collect(df[:,2])), xlabel = string(names(df)[2]), xticks = (1:length(df[:,1]), df[:,1]), color=Symbol(easybarchart_inputsfunc["easybarchart_colours"][]::String), size=(parse(Float64, easybarchart_inputsfunc["easybarchart_size1"][]), parse(Float64, easybarchart_inputsfunc["easybarchart_size2"][])), legend=false)
                StatsPlots.gui()
                return true
            elseif easybarchart_inputsfunc["easybarchart_scale"][] == "log2" ## For log2 logarithmic scaling
                StatsPlots.bar(log2.(collect(df[:,2])), xlabel = string(names(df)[2]), xticks = (1:length(df[:,1]), df[:,1]), color=Symbol(easybarchart_inputsfunc["easybarchart_colours"][]::String), size=(parse(Float64, easybarchart_inputsfunc["easybarchart_size1"][]), parse(Float64, easybarchart_inputsfunc["easybarchart_size2"][])), legend=false)
                StatsPlots.gui()
                return true
            elseif easybarchart_inputsfunc["easybarchart_scale"][] == "log10" ## For log10 logarithmic scaling
                StatsPlots.bar(log10.(collect(df[:,2])), xlabel = string(names(df)[2]), xticks = (1:length(df[:,1]), df[:,1]), color=Symbol(easybarchart_inputsfunc["easybarchart_colours"][]::String), size=(parse(Float64, easybarchart_inputsfunc["easybarchart_size1"][]), parse(Float64, easybarchart_inputsfunc["easybarchart_size2"][])), legend=false)
                StatsPlots.gui()
                return true
            end
        end
