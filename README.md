...
*Note: The clustering may not be very obvious in the heatmap below because of the randomness of the dataset. The clustering will be more obvious when used with a real-life dataset.*
